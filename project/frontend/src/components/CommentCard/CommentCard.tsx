...
export const CommentCard = ({text, user_id}) => {
            const [profile, setProfile] = useState({name: 'alo'})
        ...
        credentials: 'include' })
          ...
          .catch(error => console.error('Error fetching data:', error));
            ...
            const myProfile = async () => {
                const response = await axios.get(`http://localhost:8000/users/user/${user_id}`, {withCredentials: true});
